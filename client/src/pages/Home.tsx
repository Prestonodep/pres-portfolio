          ...
          >
            <div className="container grid gap-8 lg:grid-cols-[0.42fr_0.58fr] lg:items-center">
              ...
              <div>
                ...
                <h3 className="mt-4 font-display text-[clamp(1.8rem,2.5vw,2.5rem)] font-black leading-[1.03] tracking-tight lg:mt-3">
                  {study.title}
                </h3>
                ...
                <div className="mt-7 grid gap-x-8 gap-y-6 text-[#474a52] dark:text-white/72 sm:grid-cols-2 lg:mt-5 lg:gap-y-4">
                  {(
                    [
